...
export const cnaQuestions: Question[] = [
  ...
  // ===== Final Exam Questions 11-50 =====
  { id: 176, category: 'communication', scenario: "A coworker has seemed teary and upset for weeks but hasn't shared what's wrong.", stem: "The BEST action to take would be to:", options: { A: "Tell the nurse that your coworker needs help", B: "Contact the facility supervisor", C: "Refer her to the employee assistance plan", D: "Do nothing; it is a private issue" }, correctAnswer: 'C', explanation: { correct: "The Employee Assistance Plan (EAP) provides confidential professional support for personal or work stress." }, keywords: ['coworker', 'EAP', 'support'], difficulty: 'medium' },
  { id: 177, category: 'safety-emergency', scenario: "Facility corridor safety standards.", stem: "A long-term care facility must have handrails located:", options: { A: "In the dining room", B: "On both sides of the corridors", C: "In the shower room", D: "On one side of the corridor" }, correctAnswer: 'B', explanation: { correct: "Regulations require handrails on both sides of corridors to support safe ambulation." }, keywords: ['handrails', 'corridor', 'safety'], difficulty: 'easy' },
  { id: 178, category: 'safety-emergency', scenario: "A resident is dangling at the side of the bed after being assisted up from lying.", stem: "You should:", options: { A: "Get a gait belt from the supply area", B: "Stand in front of the resident", C: "Pick out clothes from the closet", D: "Sit with the resident until he is ready to stand" }, correctAnswer: 'D', explanation: { correct: "Never leave a dangling resident unattended; stay with them until stable and ready to stand." }, keywords: ['dangling', 'safety', 'fall prevention'], difficulty: 'medium' },
  { id: 179, category: 'basic-nursing', scenario: "A resident needs oxygen due to a respiratory infection.", stem: "The BEST position for the resident while in bed is:", options: { A: "Fowler's", B: "Side-lying", C: "Prone", D: "Tripod" }, correctAnswer: 'A', explanation: { correct: "Fowler's position promotes lung expansion and eases breathing." }, keywords: ['fowlers', 'oxygen', 'respiratory'], difficulty: 'easy' },
  { id: 180, category: 'elimination', scenario: "Positioning a resident to receive an enema.", stem: "The best position is:", options: { A: "Prone", B: "Supine", C: "Sims's", D: "Semi-Fowler's" }, correctAnswer: 'C', explanation: { correct: "Left Sims's position uses gravity and colon anatomy to help retain and distribute the enema." }, keywords: ['enema', 'sims', 'positioning'], difficulty: 'medium' },
  { id: 181, category: 'infection-control', scenario: "Older adults and infection risk.", stem: "Older adults are at higher risk of infection because:", options: { A: "Blood circulation increases as a person ages", B: "People's immune systems grow weaker as they age", C: "They watch more television", D: "They don't wash their hands as often" }, correctAnswer: 'B', explanation: { correct: "Immunosenescence weakens immune defenses in older adults." }, keywords: ['aging', 'immunity', 'infection'], difficulty: 'easy' },
  { id: 182, category: 'infection-control', scenario: "Location of most staph infections.", stem: "Most staph infections occur:", options: { A: "On the skin", B: "In the digestive tract", C: "In the nose and respiratory tract", D: "In the eyes" }, correctAnswer: 'A', explanation: { correct: "Staphylococcus most often causes skin and soft-tissue infections." }, keywords: ['staph', 'skin', 'infection'], difficulty: 'medium' },
  { id: 183, category: 'infection-control', scenario: "Alcohol content required for effective hand sanitizer.", stem: "The alcohol level must be at least:", options: { A: "20%", B: "35%", C: "45%", D: "60%" }, correctAnswer: 'D', explanation: { correct: "CDC recommends hand sanitizers contain at least 60% alcohol to be effective." }, keywords: ['hand sanitizer', 'alcohol', 'CDC'], difficulty: 'easy' },
  { id: 184, category: 'vital-signs', scenario: "A resident weighs 83 pounds.", stem: "How many kilograms does the resident weigh?", options: { A: "37.7 kilograms", B: "182.6 kilograms", C: "166 kilograms", D: "41.5 kilograms" }, correctAnswer: 'A', explanation: { correct: "Divide pounds by 2.2: 83 ÷ 2.2 ≈ 37.7 kg." }, keywords: ['conversion', 'weight', 'kilograms'], difficulty: 'medium' },
  { id: 185, category: 'nutrition-hydration', scenario: "Charles drank 4 oz apple juice, 8 oz milk, and 4 oz ice cream (all fluids).", stem: "The total documented intake is:", options: { A: "360 mL", B: "480 mL", C: "12 ounces", D: "16 ounces" }, correctAnswer: 'B', explanation: { correct: "16 oz × 30 mL/oz = 480 mL. Intake is documented in mL." }, keywords: ['I&O', 'conversion', 'mL'], difficulty: 'medium' },
  { id: 186, category: 'vital-signs', scenario: "Weighing a resident on strict bed rest.", stem: "The best device is a:", options: { A: "Wheelchair scale", B: "Mechanical lift scale", C: "Stadiometer", D: "Bariatric lift scale" }, correctAnswer: 'B', explanation: { correct: "A mechanical lift scale weighs residents safely without requiring them to stand or sit up." }, keywords: ['weight', 'bed rest', 'lift'], difficulty: 'medium' },
  { id: 187, category: 'personal-care', scenario: "Michael has an IV in his right hand and needs a clean gown.", stem: "You should:", options: { A: "Feed the IV bag and tubing through the right sleeve, followed by his right arm", B: "Feed the IV bag and tubing through the left sleeve, followed by his left arm", C: "Put his right arm through the right sleeve, followed by the IV bag and tubing", D: "Have the nurse disconnect the IV tubing while you dress Michael" }, correctAnswer: 'A', explanation: { correct: "Dress the affected/IV side first: thread bag and tubing through the sleeve, then the arm." }, keywords: ['IV', 'dressing', 'affected side'], difficulty: 'medium' },
  { id: 188, category: 'basic-nursing', scenario: "Stage-two and stage-three pressure injuries.", stem: "They can be very:", options: { A: "Painful", B: "Blistered", C: "Swollen", D: "Hidden" }, correctAnswer: 'A', explanation: { correct: "Stage 2 and 3 injuries involve exposed dermis or full-thickness loss and are very painful." }, keywords: ['pressure injury', 'pain', 'staging'], difficulty: 'medium' },
  { id: 189, category: 'basic-nursing', scenario: "Function of the skin.", stem: "One of the main functions of our skin is to:", options: { A: "Carry nutrients", B: "Clump melanocytes", C: "Protect against infection", D: "Transport oxygen" }, correctAnswer: 'C', explanation: { correct: "The skin acts as the body's first barrier against infection." }, keywords: ['skin', 'barrier', 'infection'], difficulty: 'easy' },
  { id: 190, category: 'personal-care', scenario: "Making an occupied bed but no bath blankets are available.", stem: "You should:", options: { A: "Dress the resident first and then make her bed", B: "Make the bed without covering the resident", C: "Have the resident sit in a chair while you make the bed", D: "Use the bedspread to cover the resident" }, correctAnswer: 'A', explanation: { correct: "Preserve privacy and warmth by dressing the resident before changing the bed." }, keywords: ['occupied bed', 'privacy', 'dignity'], difficulty: 'medium' },
  { id: 191, category: 'mobility', scenario: "A resident after orthopedic surgery.", stem: "They are likely to be assigned a:", options: { A: "Lengthy NPO status", B: "Weight-bearing status", C: "Speech therapist", D: "One-on-one nursing assistant" }, correctAnswer: 'B', explanation: { correct: "Post-op orthopedic residents receive specific weight-bearing orders (NWB, PWB, FWB)." }, keywords: ['orthopedic', 'weight-bearing', 'post-op'], difficulty: 'medium' },
  { id: 192, category: 'elimination', scenario: "Collecting a stool specimen.", stem: "The stool sample may be taken from:", options: { A: "A commode hat", B: "A traditional bedpan", C: "A clean, unused commode", D: "All of the above" }, correctAnswer: 'A', explanation: { correct: "A clean commode hat isolates stool from urine and toilet water, keeping the specimen uncontaminated." }, keywords: ['stool specimen', 'commode hat'], difficulty: 'medium' },
  { id: 193, category: 'vital-signs', scenario: "Adult blood pressure readings.", stem: "Which blood pressure is NOT within normal limits?", options: { A: "108/72", B: "128/84", C: "118/76", D: "100/80" }, correctAnswer: 'D', explanation: { correct: "100/80 has an abnormally narrow pulse pressure (only 20 mmHg)." }, keywords: ['blood pressure', 'pulse pressure'], difficulty: 'hard' },
  { id: 194, category: 'vital-signs', scenario: "Taking an axillary temperature.", stem: "The thermometer is placed:", options: { A: "Under the resident's tongue", B: "On the resident's forehead", C: "Into the resident's ear canal", D: "Under the resident's arm" }, correctAnswer: 'D', explanation: { correct: "Axillary means under the arm." }, keywords: ['axillary', 'temperature'], difficulty: 'easy' },
  { id: 195, category: 'patient-rights', scenario: "You need Emily's vital signs; she is playing bingo.", stem: "You should:", options: { A: "Get her vital signs later so you do not disturb the game", B: "After getting Emily's permission, take her to a private room and obtain the vital signs", C: "Take the vital signs in the activity room while Emily continues to play", D: "Tell the nurse that you will get the vital signs after bingo is done" }, correctAnswer: 'B', explanation: { correct: "Respect privacy and dignity by obtaining consent and moving to a private area." }, keywords: ['privacy', 'consent', 'dignity'], difficulty: 'medium' },
  { id: 196, category: 'basic-nursing', scenario: "Body composition.", stem: "The human body is made up of mostly:", options: { A: "Vitamins", B: "Water", C: "Bones", D: "Muscles" }, correctAnswer: 'B', explanation: { correct: "The adult body is roughly 60% water." }, keywords: ['water', 'body composition'], difficulty: 'easy' },
  { id: 197, category: 'basic-nursing', scenario: "Post-op knee-repair resident requesting ginger ale and crackers.", stem: "Before you can give these to him, he must first:", options: { A: "Have bowel sounds", B: "Sit upright for 30 minutes", C: "Tolerate chicken broth", D: "Ambulate 30 feet" }, correctAnswer: 'A', explanation: { correct: "Bowel sounds confirm returning GI function required before advancing diet." }, keywords: ['post-op', 'bowel sounds', 'diet'], difficulty: 'hard' },
  { id: 198, category: 'nutrition-hydration', scenario: "Indications for a pureed diet.", stem: "A resident might need a pureed diet if he:", options: { A: "Has use of only his right hand", B: "Chokes easily on his coffee and juice", C: "Can no longer wear his dentures", D: "Has a difficult time chewing and swallowing meat" }, correctAnswer: 'D', explanation: { correct: "Pureed diets are ordered when chewing and swallowing solid foods is difficult. Choking on liquids requires thickened liquids, not pureed food." }, keywords: ['pureed', 'dysphagia', 'diet'], difficulty: 'medium' },
  { id: 199, category: 'safety-emergency', scenario: "A resident begins to fall.", stem: "The nursing assistant must:", options: { A: "Yell for another nursing assistant to help", B: "Assist the resident to the floor while protecting the resident's head from injury", C: "Stop the resident from falling by holding her up with the gait belt", D: "Let go of the resident to prevent injuring herself" }, correctAnswer: 'B', explanation: { correct: "Ease the resident to the floor protecting the head to prevent worse injury." }, keywords: ['fall', 'safety', 'head protection'], difficulty: 'medium' },
  { id: 200, category: 'safety-emergency', scenario: "A resident has fallen.", stem: "Update the nurse:", options: { A: "After you get the resident back to bed", B: "At the end of the shift", C: "Only if the resident is hurt", D: "Immediately following the fall" }, correctAnswer: 'D', explanation: { correct: "Never move a fallen resident until the nurse assesses them; report immediately." }, keywords: ['fall', 'reporting', 'immediate'], difficulty: 'easy' },
  { id: 201, category: 'safety-emergency', scenario: "Restraint use across care settings.", stem: "A nursing assistant is MOST likely to use a restraint in a(n):", options: { A: "Long-term care facility", B: "Assisted-living facility", C: "Emergency room", D: "Respite care facility" }, correctAnswer: 'A', explanation: { correct: "When used, restraints are most commonly encountered in long-term care." }, keywords: ['restraints', 'long-term care'], difficulty: 'medium' },
  { id: 202, category: 'basic-nursing', scenario: "Gradual thinning of bone tissue.", stem: "This condition is called:", options: { A: "Kyphosis", B: "Rheumatoid arthritis", C: "Contracture", D: "Osteoporosis" }, correctAnswer: 'D', explanation: { correct: "Osteoporosis is progressive loss of bone density." }, keywords: ['osteoporosis', 'bone'], difficulty: 'easy' },
  { id: 203, category: 'safety-emergency', scenario: "A resident falls trying to self-transfer.", stem: "To activate EMS, you should:", options: { A: "Contact the administrator", B: "Call for the charge nurse", C: "Dial 911 and wait for the ambulance", D: "Call the nearest emergency room" }, correctAnswer: 'C', explanation: { correct: "Activating EMS means calling 911." }, keywords: ['EMS', '911', 'emergency'], difficulty: 'easy' },
  { id: 204, category: 'basic-nursing', scenario: "Parkinson's disease symptoms.", stem: "Symptoms you might expect include:", options: { A: "Hand tremors and slowed body movements", B: "Red, swollen, and painful joints", C: "Fever, cough, and night sweats", D: "Frequent urination and fruity breath" }, correctAnswer: 'A', explanation: { correct: "Parkinson's causes tremor, bradykinesia (slowed movement), rigidity, and postural instability." }, keywords: ['parkinsons', 'tremor'], difficulty: 'medium' },
  { id: 205, category: 'mobility', scenario: "Benefits of range-of-motion exercises.", stem: "ROM exercises can help:", options: { A: "Prevent contractures", B: "Improve comfort", C: "Reduce the risk of atrophy", D: "Do all of the above" }, correctAnswer: 'D', explanation: { correct: "ROM prevents contractures, promotes comfort, and reduces atrophy." }, keywords: ['ROM', 'contractures', 'atrophy'], difficulty: 'easy' },
  { id: 206, category: 'mobility', scenario: "Performing ROM including abduction.", stem: "Abduction means:", options: { A: "Increasing the joint angle", B: "Moving away from the midline of the body", C: "Moving toward the midline of the body", D: "Moving the foot so the toes are pointing downward" }, correctAnswer: 'B', explanation: { correct: "Abduction = movement away from midline; adduction = toward midline." }, keywords: ['abduction', 'ROM', 'terminology'], difficulty: 'medium' },
  { id: 207, category: 'mobility', scenario: "Assisting an independent resident with exercise or ambulation.", stem: "You can:", options: { A: "Use verbal encouragement", B: "Be close during ambulation", C: "Use a gait belt during ambulation and movement", D: "Do nothing; you do not need to assist an independent resident" }, correctAnswer: 'A', explanation: { correct: "Independent residents don't require physical assist; verbal encouragement supports their independence." }, keywords: ['independence', 'encouragement'], difficulty: 'medium' },
  { id: 208, category: 'communication', scenario: "Mrs. Stewart limps and grimaces during a walk, stating she hurt her foot.", stem: "The subjective data to report is that Mrs. Stewart:", options: { A: "Is experiencing foot pain", B: "Stated that she hurt herself", C: "Is refusing to walk", D: "Was limping during her walk" }, correctAnswer: 'A', explanation: { correct: "Pain is subjective — only the resident can report it. The others are objective observations." }, keywords: ['subjective', 'pain', 'reporting'], difficulty: 'hard' },
  { id: 209, category: 'body-mechanics', scenario: "Anatomical terminology.", stem: "The term 'proximal' means:", options: { A: "Toward the front side of the body", B: "The side of the body", C: "Away from the midline of the body", D: "The nearer of two points on the body" }, correctAnswer: 'D', explanation: { correct: "Proximal = closer to the point of reference (usually the trunk)." }, keywords: ['proximal', 'anatomy'], difficulty: 'medium' },
  { id: 210, category: 'communication', scenario: "Assuming a resident's food preferences.", stem: "This is an example of being:", options: { A: "Subjective", B: "Factual", C: "Unbiased", D: "Objective" }, correctAnswer: 'A', explanation: { correct: "Assumptions and personal opinions are subjective." }, keywords: ['subjective', 'assumptions'], difficulty: 'medium' },
  { id: 211, category: 'end-of-life', scenario: "Signs of approaching death.", stem: "Mottling is most likely to appear on the resident's:", options: { A: "Chest", B: "Abdomen", C: "Legs and feet", D: "Face" }, correctAnswer: 'C', explanation: { correct: "Mottling typically begins in the lower extremities as circulation slows." }, keywords: ['mottling', 'end-of-life'], difficulty: 'medium' },
  { id: 212, category: 'end-of-life', scenario: "Dorian is dying of prostate cancer and coughs and shakes his head with each bite of breakfast.", stem: "You should:", options: { A: "Continue to offer him his breakfast", B: "Stop, ensure that he is safe, and then update the nurse", C: "Give him only his fluids until he is no longer coughing", D: "Tell him he won't feel better unless he eats something" }, correctAnswer: 'B', explanation: { correct: "Coughing signals aspiration risk — stop feeding, ensure safety, and report to the nurse." }, keywords: ['aspiration', 'end-of-life', 'safety'], difficulty: 'medium' },
  { id: 213, category: 'end-of-life', scenario: "Eva says her brother would still be alive if the doctor had caught the cancer sooner.", stem: "The stage of grief Eva is most likely experiencing is:", options: { A: "Acceptance", B: "Denial", C: "Bargaining", D: "Anger" }, correctAnswer: 'D', explanation: { correct: "Blaming others is characteristic of the anger stage of grief." }, keywords: ['grief', 'anger', 'Kubler-Ross'], difficulty: 'medium' },
  { id: 214, category: 'communication', scenario: "A resident speaks only Spanish and you cannot explain your actions.", stem: "You should:", options: { A: "Ask your supervisor for a different assignment", B: "Tell the resident's family that they will need to interpret", C: "Ask the nurse if the facility has a translator available", D: "Raise your voice when speaking and point at items" }, correctAnswer: 'C', explanation: { correct: "Facilities are required to provide interpreter services for effective communication." }, keywords: ['translator', 'language', 'communication'], difficulty: 'easy' },
  { id: 215, category: 'abuse-neglect', scenario: "Why older residents may be at risk of abuse.", stem: "They:", options: { A: "Often don't recognize abuse when it happens", B: "Strike out at others", C: "May fear losing their caregiver", D: "Have little control over their actions" }, correctAnswer: 'C', explanation: { correct: "Fear of losing their caregiver or retaliation keeps many older adults from reporting abuse." }, keywords: ['abuse', 'elder', 'fear'], difficulty: 'medium' }
];
