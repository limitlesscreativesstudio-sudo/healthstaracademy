...
const BlogPage = () => {
  const allArticles = [
    ...
    {
      slug: "cna-salary-california-2026",
      title: "CNA Salary in California 2026: Pay by City, Setting, and Shift",
      excerpt: "What CNAs really earn in California in 2026 — hourly pay by city, shift differentials, and 5 ways new CNAs can boost their wage.",
      author: "Health Star Academy",
      date: "June 3, 2026",
    ...
    {
      slug: "day-in-the-life-of-a-cna",
      title: "A Day in the Life of a CNA: What 8 and 12-Hour Shifts Really Look Like",
      excerpt: "Hour-by-hour breakdown of a real CNA shift in a California skilled nursing facility and hospital — patients, breaks, and pace.",
      author: "Health Star Academy",
      date: "June 10, 2026",
    ...
    {
      slug: "financing-cna-training-california",
      title: "Financing Your CNA Training: Denefits, Payment Plans & Free Options",
      excerpt: "Every real way to pay for CNA school in California — Denefits no-credit-check financing, WIOA grants, payment plans, and employer-paid options.",
      author: "Health Star Academy",
      date: "June 17, 2026",
      publishDate: new Date("2026-06-17"),
      readTime: "9 min read",
      category: "Financing",
      image: instructorTeachingMannequin,
    },
    {
      slug: "cna-vs-hha-vs-medical-assistant",
      title: "CNA vs HHA vs Medical Assistant: Which California Healthcare Role Fits You?",
      excerpt: "Side-by-side comparison of CNA, HHA, and Medical Assistant — pay, training time, scope, and which path opens the most doors in California.",
      author: "Health Star Academy",
      date: "June 24, 2026",
    ...
    {
      slug: "cna-programs-fremont-east-bay",
      title: "CNA Programs in Fremont & the East Bay: Hybrid Options That Fit",
      excerpt: "CDPH-approved CNA training for Fremont, Hayward, Union City, and the East Bay. Online theory + Hayward clinicals, finish in 6 weeks.",
      author: "Health Star Academy",
      date: "July 1, 2026",
    ...
    {
      slug: "cna-to-rn-california",
      title: "From CNA to RN in California: Bridge Programs, Costs & Real Timeline",
      excerpt: "How working CNAs use bridge programs and employer reimbursement to become RNs in 2–4 years with minimal debt.",
      author: "Health Star Academy",
      date: "July 8, 2026",
