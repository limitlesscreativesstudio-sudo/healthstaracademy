  ...
  return (
    <>
      <SEO
        ...
        structuredData={buildBreadcrumbSchema([{ name: "Blog", path: "/blog" }, { name: "Nursing Career Foundations", path: "/blog/nursing-career-foundations" }])}
      />
      ...
      <article className="section-padding bg-background">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-dark mb-6 leading-relaxed">
              <strong>Certified Nursing Assistant (CNA):</strong> The entry point for most nursing careers. CNAs provide essential patient care under supervision of licensed nurses. Training typically requires 160 hours, completed in as little as 6.5 weeks at programs like Health Star Academy. CNAs in California earn competitive wages, typically between $18-25 per hour.
            </p>
            <p className="text-gray-dark mb-6 leading-relaxed">
            ...
            <p className="text-gray-dark mb-6 leading-relaxed">
              At Health Star Academy, we've made CNA training affordable and accessible. Our all-inclusive tuition of $2,499 covers everything, and students are provided a Chromebook to use during the program for accessing course materials. We accept payments through Stripe with options including Klarna, Afterpay, Zip, and Apple Pay. Payment plans are available through Self-Help Federal Credit Union and Denefits for those needing financing assistance.
            </p>
            <p className="text-gray-dark mb-6 leading-relaxed">
