      ...
      <article className="section-padding bg-background">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-dark mb-6 leading-relaxed">
              First, CNA training programs are relatively short and affordable compared to other healthcare certifications. At Health Star Academy, our CDPH-approved program can be completed in as little as 6.5 weeks, allowing you to enter the workforce quickly while minimizing your upfront investment. This accelerated timeline means you can start earning competitive wages within weeks rather than years.
            </p>
            <p className="text-gray-dark mb-6 leading-relaxed">
            ...
            <p className="text-gray-dark mb-6 leading-relaxed">
              Our all-inclusive program cost of $2,499 covers tuition, textbooks, uniforms, and clinical supplies. Students are also provided a Chromebook to use during the program for accessing course materials. We accept payments through Stripe, offering flexible options including Klarna, Afterpay, Zip, and Apple Pay. Additionally, payment plans are available through Self-Help Federal Credit Union and Denefits, which offers no credit check financing with guaranteed approvals.
            </p>
            <p className="text-gray-dark mb-6 leading-relaxed">
